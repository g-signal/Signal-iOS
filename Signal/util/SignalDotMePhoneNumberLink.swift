...
/// number. These URLs look like `{https,baxs}://me.baxs.com/#p/<e164>`.
class SignalDotMePhoneNumberLink {
    private static let pattern = try! NSRegularExpression(pattern: "^(?:https|\(UrlOpener.Constants.sgnlPrefix))://me.baxs.com/#p/(\\+[0-9]+)$", options: [])
