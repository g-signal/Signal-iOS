...
public extension TSInvalidIdentityKeySendingErrorMessage {
    ...
    class func fetchInvalidIdentityKeySendingErrorMessageViaCache(
        uniqueId: String,
    ...
    // NOTE: This method will fail if the object has unexpected type.
    func anyUpdateInvalidIdentityKeySendingErrorMessage(transaction: DBWriteTransaction, block: (TSInvalidIdentityKeySendingErrorMessage) -> Void) {
...
class TSInvalidIdentityKeySendingErrorMessageSerializer: SDSSerializer {
    ...
    public init(model: TSInvalidIdentityKeySendingErrorMessage) {
        self.model = model
    }
